...
export type SeedableNoiseMap = (seed: number) => NoiseMap;
...
function wrapWithPerm(hmBuilder: (p: number[], grad: Grad[]) => NoiseMap): SeedableNoiseMap {
	return (seed: number): NoiseMap => {
		...
		return hmBuilder(perm, gradP);
	}
}

export const simplex2: SeedableNoiseMap = wrapWithPerm(function simplex2(perm, gradP): NoiseMap {
